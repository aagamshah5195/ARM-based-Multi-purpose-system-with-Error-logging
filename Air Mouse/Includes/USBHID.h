...
#ifndef INCLUDES_USBHID_H_
#define INCLUDES_USBHID_H_
...
//public:
    ...
    */
    //USBHID(uint8_t output_report_length = 64, uint8_t input_report_length = 64, uint16_t vendor_id = 0x1234, uint16_t product_id = 0x0006, uint16_t product_release = 0x0001, uint8_t connect = true);
    ...
    */
    uint8_t send(HID_REPORT *report);
    ...
    * @returns true if successful
    */
    uint8_t sendNB(HID_REPORT *report);
    ...
    * @returns true if successful
    */
    uint8_t read(HID_REPORT * report);
    ...
    * @returns true if successful
    */
    uint8_t readNB(HID_REPORT * report);
...
//protected:
    ...
    */
   //  void HID_callbackSetReport(HID_REPORT *report){};
  ...
  uint8_t USBCallback_request();
    ...
    * @returns true if class handles this request
    */
     uint8_t USBCallback_setConfiguration(uint8_t configuration);
